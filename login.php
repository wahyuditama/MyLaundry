...
if (isset($_POST['login'])) {
    ...
    if ($queryLogin) {
        ...
        if ($password == $rowEmail['password']) {
            $_SESSION['nama'] = $rowEmail['nama'];
            $_SESSION['id'] = $rowEmail['id'];
            $_SESSION['id_level'] = $rowEmail['id_level'];
            header('Location:index.php');
        } else {
            header('Location: login.php?login=gagal');
        }
...
<head>
    ...
    <style>
        .section-buy-now .btn-section-buy-now {
            position: fixed;
            bottom: 3rem;
            right: 1.625rem;
            z-index: 999999;
        ...
        .section-buy-now .btn-section-buy-now:hover {
            box-shadow: none;
        }
    </style>
</head>
...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang di Lorem !👋</h4>
    ...
    <div class="section-buy-now">
        <a
            ...
            target="_blank"
            class="btn btn-outline-success btn-section-buy-now">Welcome To My Laundry</a>
    </div>
